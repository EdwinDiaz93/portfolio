...
const FeedbackCard = ({ index, testimonial, name, designation, company, image }) => {
  return (
    ...
    >
      <p className="text-white font-bold text-[3rem]">"</p>
      <div className="mt-1">
...
const Feedbacks = () => {
  return (
    <div
      className="mt-12 bg-black-100 rounded-[1.3rem]"
    >
      <div className={`${styles.padding} bg-tertiary rounded-2xl min-h-[19rem]`}>
